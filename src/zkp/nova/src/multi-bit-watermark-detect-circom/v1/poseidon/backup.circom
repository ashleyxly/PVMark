...
template each_position_detect(partial_seq_len, each_position_infor, nLevels) {
    ...
    // signal input step_in[each_position_infor + 2];
    // signal output step_out[each_position_infor + 2];
    ...
    // step_out[each_position_infor] <== output_hasher2.out;
    ...
    // step_out[each_position_infor + 1] <== output_hasher3.out;
...
// component main { public [step_in] } = each_position_detect(1, 2, 1);

component main = each_position_detect(1, 2, 1);