...
// /mnt/disk2/username/kzg-halo2-merkle-tree/test_result/test_verify_detect_text_watermark/input.txt
   ...
   #[arg(short, long, default_value = "/mnt/disk2/username/lm-watermarking/test_result/halo2_circuit_public_inputs.txt")]
   input_file_path: String,

   /// The path of output file including counting results
   #[arg(short, long, default_value = "/mnt/disk2/username/kzg-halo2-merkle-tree/test_result/test_verify_detect_text_watermark/output.txt")]
