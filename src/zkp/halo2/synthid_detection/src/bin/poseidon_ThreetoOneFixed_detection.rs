...
use rand::Rng;
// use std::io::Result;
// use halo2_detection::chips::poseidon::{PoseidonChip, PoseidonConfig};
use halo2_detection::chips::poseidon_3::{PoseidonChip, PoseidonConfig};
// use halo2_detection::chips::less_than_chip::{LessThanChip, LessThanConfig, self};
use halo2_detection::chips::add_chip::{AddChip, AddConfig, self};
use halo2_detection::poseidon::spec_width_4::{POSEIDON_WIDTH, POSEIDON_RATE};
use halo2_detection::poseidon::spec_width_4::PoseidonSpec;
...
//    /// File to read
//    filename: String,
// ${PVMark_EXTERNAL_DATA_ROOT:-external}

    /// The path of input file including public inputs
   #[arg(short, long, default_value = "${PVMark_EXTERNAL_DATA_ROOT:-external}")]
